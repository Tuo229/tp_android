...
public class VideoViewUtils {
    ...
    public static void playRawVideo(Context context, VideoView videoView, String resName)  {
        try {
            ...
            Uri uri = Uri.parse("android.resource://" + context.getPackageName() + "/" + R.raw.combat);
    ...
    String localPath = "/run/user/1001/gvfs/mtp:host=Xiaomi_Redmi_Note_11_2b68ba34/Espace de stockage interne partagé/DCIM/Snapchat/Snapchat-1493937080.mp4";
